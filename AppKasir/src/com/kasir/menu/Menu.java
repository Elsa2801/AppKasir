...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"~MENU~"},
        {"Transaksi"},
        {"Pesanan", "Pesanan Masuk", "Pesanan dalam Proses", "Selesai"},
        {"Laporan", "Pemasukan","Benefit"},
        {"Karyawan","Tambah Karyawan", "List Karyawan","Absensi Karyawan"},
        {"Layanan","Daftar Layanan", "Tambah Layanan"},
        {"Pelanggan","List Pelanggan", "Tambah Pelanggan"},
        {"Notifikasi"},
        {"~OTHERS~"},
        {"KELUAR"},
    };
    ...
    private final String headerName = "SoClean Laundry";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/com/kasir/icon/logobener.png")));
