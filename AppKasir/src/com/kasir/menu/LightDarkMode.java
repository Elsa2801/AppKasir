...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("com/kasir/icon/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("com/kasir/icon/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("com/kasir/icon/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("com/kasir/icon/light.svg"));
        }
    }
