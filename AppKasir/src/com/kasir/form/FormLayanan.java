...
public class FormLayanan extends javax.swing.JPanel {
    ...
    private final TableModelLayanan tblLayanan = new TableModelLayanan();
    private final ServiceLayanan servis = new LayananDAO();

    public FormLayanan() {
        initComponents();
        tblData.setModel(tblLayanan);
        loadData();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DAFTAR LAYANAN");
        ...
        tblData.setFont(new java.awt.Font(".AppleSystemUIFont", 0, 14)); // NOI18N
    ...
    private void pencarianData(){
        List<ModelLayanan> list = servis.pencarianData(txtPencarian.getText());
        tblLayanan.setData(list);
    }

    private void tambahData() {
        FormInputLayanan formInput = new FormInputLayanan(null, true,1,null);
    ...
    private void perbaruiData() {
        ...
        if(row != -1) {
            ModelLayanan layanan = tblLayanan.getData(row);
            FormInputLayanan formInput = new FormInputLayanan(null, true, row, layanan);
            formInput.setVisible(true);
            loadData();
        } else {
    ...
    private void hapusData() {
        ...
        if(row != -1){
            ...
            servis.hapusData(layanan);
            tblLayanan.deleteData(row);
            loadData();
        }else {
